...
exports.requiresAuthorization = (req, res, next) => {
  ...
  if (_.isEmpty(reqHeaderSecretKey)) {
    return MiscHelper.errorCustomStatus(
      res,
      'Unauthorized, need access token to access this API route',
      401
    )
  }

  const internalAccess = _.includes(
  ...
  if (!internalAccess) {
    return MiscHelper.errorCustomStatus(
      res,
      'Unauthorized, authorization value is invalid/expired',
      401
    )
  }
